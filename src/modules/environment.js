...
const ground = new THREE.Mesh(
  new THREE.PlaneGeometry(60000, 60000), // Increased ground size
...
const cloudLayer = new THREE.Mesh(
  new THREE.PlaneGeometry(60000, 60000), // Increased cloud size
...
function loadCities(scene) {
  const cityConfigs = [
    ...
    },
    {
      ...
      scale: 100,
      position: new THREE.Vector3(11000, 0, 2000),
    },
    {
      path: "cities/Little City.glb",
      scale: 10000,
      position: new THREE.Vector3(-10000, 0, 2000),
    },
  ];
